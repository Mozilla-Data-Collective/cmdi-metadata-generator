...
def fill_template(dataset_info):
	...
	dataset_record = dataset_record.replace('{Name0}', escape(dataset_info['name']))
	dataset_record = dataset_record.replace('{Title0}', escape(dataset_info['name']))
	...
	dataset_record = dataset_record.replace('{Description0}', escape(dataset_info['longDescription']).strip())
